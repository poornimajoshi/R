...
## 2.2 Cleaning and preparing data for analysis{.smaller}
  ...
  - Cagetorised the number of installs less than 100,000 as unsuccessful and  greater than 100,000 as successful
...
## 5 Measuring true possitives and False Positives{.smaller}
```{r, include=FALSE}
library(ROCR)
```
